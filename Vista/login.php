        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form id="loginForm" class="p-6 space-y-4" action="/TrabajoFinalPWD/auth/login.php" method="post" novalidate>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="/TrabajoFinalPWD/Vista/forgot.php" class="text-sm text-indigo-600 hover:underline">¿Olvidaste tu contraseña?</a>
                </div>
                ...
                <div class="text-center text-sm text-gray-500">
                    ¿No tenés cuenta?
                    <a href="/TrabajoFinalPWD/Vista/register.php" class="text-indigo-600 hover:underline">Crear cuenta</a>
                </div>
